...
type HeartbeatPacket struct {
	...
	HbCount  int32 `protobuf:"varint,1,opt,name=hbCount,proto3" json:"hbCount,omitempty"`
...
func (x *HeartbeatPacket) GetHbCount() int32 {
	if x != nil {
		return x.HbCount
	}
	return 0
...
func (x *HeartbeatPacket) GetSentTime() int64 {
	if x != nil {
		return x.SentTime
	}
	return 0
...
var file_heartbeat_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x47, 0x0a, 0x0f, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65,
	0x61, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x68, 0x62, 0x43, 0x6f,
	0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x68, 0x62, 0x43, 0x6f, 0x75,
	0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x73, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x05,
	0x5a, 0x03, 0x2e, 0x3b, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_heartbeat_proto_goTypes = []interface{}{
	(*HeartbeatPacket)(nil), // 0: pb.HeartbeatPacket
}
